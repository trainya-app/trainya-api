...
memberPhotoProgress.put('/member-uploadFirstPhoto/:monthId', MulterMiddleware_1.default.single('photo'), firebase_1.uploadFiles, MemberPhotoProgressController_1.default.uploadFirstPhoto);
memberPhotoProgress.put('/member-uploadSecondPhoto/:monthId', MulterMiddleware_1.default.single('photo'), firebase_1.uploadFiles, MemberPhotoProgressController_1.default.uploadSecondPhoto);
memberPhotoProgress.put('/member-uploadThirdPhoto/:monthId', MulterMiddleware_1.default.single('photo'), firebase_1.uploadFiles, MemberPhotoProgressController_1.default.uploadThirdPhoto);
